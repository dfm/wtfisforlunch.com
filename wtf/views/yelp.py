...
from wtf.models import Proposal, YelpListing
...
def get_yelp_list(loc):
    ...
    for i in range(ntries):
        ...
        data = [YelpListing(d) for d in r.json()["businesses"]]
...
def main(rejectid=None, blackid=None):
    ...
    result = {
        ...
        "short_categories": choice.short_categories,
        "url": choice.url,
        ...
        "map_link": "http://maps.google.com/?q="
                    + urllib.quote(choice.search_address)
    }
